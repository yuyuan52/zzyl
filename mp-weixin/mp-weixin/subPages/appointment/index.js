...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getSearchList = async () => {
      const time2 = utils_index.getDsec(nowDate.value);
      const params = {
        time: time2
      };
      allTimeAll.value = [];
    ...
    const bindFamily = (val) => {
      form.value.formData.visitor = val.elderName;
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-e98dc5bd"], ["__file", "D:/project/2024/project-zhyl-xcx-uniapp-java-hongbo-v2.0/project-zhyl-xcx-uniapp-java2.0/subPages/appointment/index.vue"]]);
