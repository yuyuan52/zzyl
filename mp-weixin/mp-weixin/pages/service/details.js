  ...
  setup(__props) {
    ...
    const handleSub = async () => {
      if (!isClick.value) {
        ...
        if (nowDate.value === "" || !nowDate.value) {
        ...
        await pages_api_service.goodsViseiOrder(params).then((res) => {
          if (res.code === 200) {
            const date = utils_index.getTate(nowDate.value);
            const params2 = {
              ...formData.value,
            ...
            common_vendor.index.navigateTo({
              url: `/pages/service/orderVerify?item=${encodeURIComponent(
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        r: common_vendor.o(bindPicker),
        s: common_vendor.o(closePicView),
        t: common_vendor.p({
          nowDate: nowDate.value,
          ispicView: ispicView.value
        }),
        v: common_vendor.sr(familyPopup, "8d98c490-3", {
          "k": "familyPopup"
        }),
        w: common_vendor.o(bindFamily),
        x: common_vendor.p({
          serviceVal: serviceVal.value,
          formData: formData.value,
          allElderData: allElderData.value
        }),
        y: common_vendor.sr(popupLook, "8d98c490-4", {
          "k": "popupLook"
        })
      });
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-8d98c490"], ["__file", "D:/project/2024/project-zhyl-xcx-uniapp-java-hongbo-v2.0/project-zhyl-xcx-uniapp-java2.0/pages/service/details.vue"]]);
